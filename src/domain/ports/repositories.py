...
class PeriodRepoPort(BaseRepo[Period], Protocol):
...
class BillingRepoPort(BaseRepo[Invoice], _Activatable[Invoice], _DocReachable[Invoice], Protocol):
...
class ClaimRepoPort(
    BaseRepo[Claim], _DocReachable[Claim], _Activatable[Claim], Protocol
):
    def get_by_text_like(self, text: str) -> Claim | None: ...


class SosClaimRepoPort(BaseRepo[SosClaim], Protocol):
...
class GroupClaimRepoPort(BaseRepo[GroupClaim], _Activatable[GroupClaim], _DocReachable[GroupClaim], Protocol):
...
class DocumentRepoPort(BaseRepo[Document], Protocol):
    ...
    def remove_document_entity(self, document_id: UUID, entity_type: str, entity_id: UUID) -> None: ...
