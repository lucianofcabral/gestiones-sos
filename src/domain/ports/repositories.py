...
class BillingRepoPort(
    BaseRepo[Invoice], _Activatable[Invoice], _DocReachable[Invoice], Protocol
):
...
class GroupClaimRepoPort(
    BaseRepo[GroupClaim], _Activatable[GroupClaim], _DocReachable[GroupClaim], Protocol
):
