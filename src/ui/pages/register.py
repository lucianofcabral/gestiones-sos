        ...
        with ui.column().classes("absolute-center items-center gap-0 w-full"):
            with ui.card().classes("w-96 shadow-xl rounded-2xl p-8 gap-4"):
                ...
                with ui.column().classes("items-center gap-1 mb-2"):
                    ...
                    ui.label("Gestiones SOS").classes("text-2xl font-bold text-blue-800")
                ...
                def do_register() -> None:
                    ...
                    if len(user_name) < 3:
                        error_label.set_text("El nombre de usuario debe tener al menos 3 caracteres.")
                        error_label.classes(remove="hidden")
                        return
                    ...
                    if len(password) < 6:
                        error_label.set_text("La contraseña debe tener al menos 6 caracteres.")
                        error_label.classes(remove="hidden")
                        return
                    ...
                    try:
                        ...
                        success_label.set_text("¡Cuenta creada! Redirigiendo al login...")
                ...
                with ui.row().classes("items-center justify-center gap-1 text-sm text-gray-500"):
