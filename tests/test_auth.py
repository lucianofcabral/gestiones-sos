...
def test_register_creates_user(user_repo, password_port):
    ...
    result = use_case.execute(RegisterInput(user_name="alice", email="alice@example.com", password="secret"))
...
def test_register_duplicate_email_raises(user_repo, password_port):
    use_case = Register(user_repo, password_port)
    use_case.execute(RegisterInput(user_name="alice", email="alice@example.com", password="s"))

    with pytest.raises(ValueError, match="Email already registered"):
        use_case.execute(RegisterInput(user_name="alice2", email="alice@example.com", password="s"))
